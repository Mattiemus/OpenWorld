...
import CubeIcon from '../../../editor/core/components/icons/cube-icon';
...
import OpenFolderIcon from '../../../editor/core/components/icons/open-folder-icon';
...
const InstanceIcon = memo((props: InstanceIconProps) => {
