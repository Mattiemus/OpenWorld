...
import PerspectiveCameraProxy from '../../../client-shared/services/graphics/proxies/perspective-camera-proxy';
...
export default class ClientWorldImpl extends BrowserWorldImpl
{
    ...
    protected onAttatch(dataModel: World): void {
        ...
        this._currentCameraChangedConnection = dataModel
            .getPropertyChangedSignal('currentCamera')!
            .connect(this.onWorldCurrentCameraChanged.bind(this));
    }
